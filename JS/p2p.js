...
headBlock.appendChild(headFragement);
...
var contentData = [
	...
	},
	{
		...
		p1:"最近，一个约10G容量，名为“女大学生裸条”的照片和视频压缩包在网上疯传，其中女生大多出生于1993-1997年，最年轻的还不满18岁。",
		p2:"事实上，“裸条”是一种“抵押物”，有它，女生才能拿到P2P借款，这样的借贷行为被称为“裸贷”。如此，当女生借款逾期后，P2P催收员就能拿出催款“杀手锏”，给予其超常的心理压力。相比传统的高利贷，裸贷的月息超30%已是不成文的规定。而更可怕的是，一切在黑产演绎下，肉偿还债，裸条买卖盛行，各种触目惊心，刷新着人们认知的底线。",
		p4:"某P2P小伙伴告诉小郝子，其实，早在央视等大媒体曝光前，今年3、4月间，已经有一部分裸条陆续流出，很多P2P平台深感这事“捂不住”，更早已经开始了“转型”。",
		p3:"一方面，对用户和公众，很多P2P平台重新包装“消费金融”概念，为P2P的污名脱敏；另一方面，P2P转而投身金融资产交易所（简称“金交所”），“有能耐的”的直接发起或参股建立金交所，“有思路的”也“扭捏着身体”钻入金交所的“热炕头”，参与到相关项目中去，它们将校园贷、消费分期、个人短期贷，混着各种信托收益权、债权、应收账款收益权等“资产”，改头换面，成就类证券化玩法，在金交所里寻求“接盘侠”，规避越来越严的P2P管制，玩转资产游戏，博取高回报。",
		p4:"“但这个过程中，隐含巨大风险。”有业内人士告诉小郝子，P2P各种借贷风险不同，在金交所打包、封装的同时，并没有形成一个完善的风险识别、确定标准，如此，相关资产的“接盘侠”，若一时“猪油蒙了心，脑子勾了芡”，不能明晰其中风险，那就很可能承担风险损失，变成“背锅侠”。P2P最不该的，是刷着银行业的业绩，却投机取巧、不顾风险地去赚金融市场才有的利润。",
		href:""
		
	},
	{
		img:"./images/papAheadPic_01.jpg",
		p1:"据CNNIC最新发布的《中国互联网络发展状况统计报告》数据显示，我国网民总规模达7.10亿，购买互联网理财产品的网民规模超过1.01亿。在互金类应用、网上支付和互联网理财用户规模等诸多因素助推下，我国互金行业发展迎来了质的飞跃。",
		p2:"但是自《网络借贷信息中介机构业务活动管理暂行办法》发布以来，这个被称为“史上最严苛”的网贷行业政策对整个行业环境产生巨大影响。网贷行业是否会被“管死”成为业界讨论焦点，有些平台在“怨声载道”中无奈退出，有些则在挑战中寻找新的机遇。《暂行办法》发布已过去三个多月的时间，积极型的平台纷纷落地一系列举措主动拥抱监管。后监管时代，在大多数平台忙于解决转型、存管、备案问题的时候，只有少数平台，从容淡定，手握合规优势。冰融贷可算其中的代表。",
		p3:"冰融贷为哈尔滨正泰投资管理有限公司旗下P2P债权流转平台，正泰投资成立于2014年7月23日，注册资金1000万人民币。公司落户于黑龙江省会城市哈尔滨，业务涵盖了包括房屋过户、不动产抵押和汽车抵押等专业、高效、安全的综合性金融资产交易相关服务及投融资顾问服务。冰融贷筹备数个月后于2014年12月8号正式上线。业务主要针对公司的线下抵押贷款项目债权网上流转。冰融贷是中国东北地区最早的一批互联网金融平台，平台上线受到多方关注及本地政府的扶持，并于2014年10月8号获得本地政府授予“政府合作企业”牌匾。",
		p4:"",
		href:"#"
	},
	{
		img:"./images/papAheadPic_03.jpg",
		p1:"今日发布合规及发展力报告的平台有：e路同心、广州易贷、搜易贷、恒易融、聚金资本、晋商贷目前累计发布报告的平台有150家。您可登陆红途官网（www.hongtuwang.com）查看简版报告。下面以友金所为例，同时释义合规与发展力报告的评审结论。",
		p2:"根据各平台最终得牌总数，依据红途界定平台违规程度的标准，最终得出平台的违规程度，并以此作为合规评审的结论。评审结论共分为完全合规、基本合规、轻度违规、中度违规、重度违规五档。",
		p3:"依据“红途网贷平台合法合规网络评审体系”对友金所进行逐项评审后，友金所获得的红牌+黄牌的数量为25，依据红途界定平台违规程度的标准，友金所属于重度违规。",
		p4:"友金所违规的部分主要集中在其理财产品上。友金所是用友集团旗下企业，背靠用友集团的强大资源，债权真实度高，但是平台主要采取的是理财产品的模式，而且友金所依然在运营现在许多平台已经停止发售的活期理财产品，也正是由于这些理财产品造成了友金所在模式及信披上的违规。好在友金所的债权真实度高，整改难度不大，且政策风险极低。",
		href:"#"
	}
];
...
contentWrap.appendChild(contentFragment);
//
var currentHead = headBlock.getElementsByClassName("headBox");
